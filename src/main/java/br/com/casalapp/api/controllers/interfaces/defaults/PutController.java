...
public interface PutController<T extends AbstractBaseEntity, D extends AbstractDto> extends HasService<T>, HasDto<T, D> {

	public static final Logger log = LoggerFactory.getLogger(PessoaController.class);

	@PutMapping
	default
	public ResponseEntity<Response<D>> atualizar(@Valid @RequestBody D dto, BindingResult result) throws NoSuchAlgorithmException {
